package demo.spring.vehicles.init;

import demo.spring.vehicles.model.entity.Brand;
import demo.spring.vehicles.model.entity.Model;
...
import static demo.spring.vehicles.model.entity.enums.Category.*;
import static demo.spring.vehicles.model.entity.enums.Role.*;
...
public class DataInitializer implements CommandLineRunner {
    ...
    @Autowired
    public DataInitializer(BrandService brandService, OfferService offerService, UserService userService) {
...
//        });
    ...
    private static final List<User> SAMPLE_USERS = List.of(
            ...
            new User("Dimitar", "Georgiev", "dimitar", "dimitar", Set.of(BUYER))
    );
}
