namespace Tree.Tests
{
    ...
    public class TreeTests
    {
        ...
        [Test]
        public void TreeAllSubtreesWithGivenSumShouldWorkCorrectly2()
        {
            string[] input = new string[]
            {
                "7 19",
            ...
            Assert.AreEqual(2, subtrees.Count);

            string treeAsString2 = subtrees[0].GetAsString();
            string treeAsString = subtrees[1].GetAsString();

            Assert.IsTrue(treeAsString.Contains("14"));
            Assert.IsTrue(treeAsString.Contains("23"));
            Assert.IsTrue(treeAsString.Contains("6"));

            Assert.IsTrue(treeAsString2.Contains("21"));
            Assert.IsTrue(treeAsString2.Contains("22"));
        }
        [Test]
